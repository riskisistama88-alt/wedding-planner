...
function renderCategoryPills() {
    ...
    categories.forEach(cat => {
        ...
        btn.className = `shrink-0 text-left px-4 py-2.5 rounded-[11px] text-[14px] font-medium flex items-center justify-between transition-all active-scale w-auto lg:w-full space-x-3 ${
            isActive ? "bg-[#0066cc] text-white" : "bg-[#f5f5f7]/60 lg:bg-transparent text-[#1d1d1f] hover:bg-[#e8e8ed] lg:hover:bg-[#f5f5f7]"
        }`;
        
        btn.innerHTML = `
            <span class="truncate">${cat === "All" ? "Semua" : cat}</span>
